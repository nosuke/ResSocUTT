			...
			<div id="centre">
				<div id="navigation">
					<ul>
						...
						<li><p><a href="../TP6/EX5_formulaire_action_session.php">Exercice précédent</a></p></li>
						<li><p><a href="./EX2_formulaire.php">Exercice suivant</a></p></li>
					</ul>
				</div><!-- #navigation -->
