...
<html>
    <head>
        <title>TP 5 : exercice 1, partie formulaire et action avec persistance des données</title>
    ...
    <body>
		...
		<div id="global">
			...
			<div id="centre">
				...
				<div id="contenu">
					<h2>Planning des soutenances, partie formulaire et action avec persistance des données</h2>
					<br/>
					...
					<?php
						function formulaire() {
							...
							<form method="POST" action="EX1_formulaire_action_persistance.php">
...
END;
					...
					<?php
						function persistance() {
							$soutenance = array (utf8_decode($_POST["jour"]), utf8_decode($_POST["mois"]), utf8_decode($_POST["annee"]), utf8_decode($_POST["heure"]), utf8_decode($_POST["salle"]) );
							
							$fichier = fopen ("soutenances.csv", "a");
							fputcsv ($fichier, $soutenance, ";");
							fclose ($fichier);
						}
					?>
