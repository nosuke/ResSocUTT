...
<html>
    <head>
        <title>TP 6 : exercice 5, partie formulaire et action avec persistance des données</title>
		...
		<div id="global">
			...
			<div id="centre">
				<div id="navigation">
					...
					<ul>
						<li><p><a href="./EX5_affichage_soutenances.php">Partie affichage des soutenances sauvegardées</a></p></li>
						<li><p><a href="./EX5_formulaire_action_session.php">Partie formulaire et action avec persistance des données</a></p></li>
					</ul>
				</div><!-- #navigation -->

				<div id="contenu">
					<h2>Sauvegarde de données complexes, partie formulaire et action avec persistance des données</h2>
					<br/>
					...
					<?php
						function formulaire() {
							...
							<form method="POST" action="EX5_formulaire_action_session.php">
...
END;
					...
					<?php
						function persistance() {
							$numeroSoutenance = count($_SESSION)+1;
							
							$_SESSION["'" . $numeroSoutenance . "'"]["jour"] = $_POST["jour"];
							$_SESSION["'" . $numeroSoutenance . "'"]["mois"] = $_POST["mois"];
							$_SESSION["'" . $numeroSoutenance . "'"]["annee"] = $_POST["annee"];
							$_SESSION["'" . $numeroSoutenance . "'"]["heure"] = $_POST["heure"];
							$_SESSION["'" . $numeroSoutenance . "'"]["salle"] = $_POST["salle"];
						}
					?>
